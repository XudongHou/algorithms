...
public class FlowEdge {
    ...
    private double flow;    //flow of the edge
    ...
    public FlowEdge(int v, int w, double capacity) {
        ...
        if (!(capacity >= 0.0)) throw new IllegalArgumentException("edge capacity must be a non-negative integer");
        this.v = v;
        this.w = w;
    ...
    public FlowEdge(int v, int w, double capacity, double flow) {
        ...
        if (!(flow >= 0.0)) throw new IllegalArgumentException("edge capacity must be a non-negative integer");
        this.v = v;
        this.w = w;
        this.capacity = capacity;
        this.flow = flow;
     ...
     */
    public void addRedidualFlowTo(int vertex, double delta) {
